...
export const scripts = toRecord([
    ...
    {
        titel: '孤独ノ隠レンボ (The Lonely Hiding Place)',
        ...
        mainPlot: ['The Cursed Doll'],
        subPlots: ['Expanding Urban Legend', 'Max Crazy Gauge'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 3,
        }],
        daysPerLoop: 5,
        cast: {
            "Boy Student": 'Spellcaster',
            "Girl Student": 'Person',
            "Rich Man’s Daughter": 'Nightmare (Haunted Stage)',
            "Shrine Maiden": 'Human Doll',
            "Police Officer": 'Ghost (Haunted Stage)',
            "Office Worker": 'Person',
            "Informer": 'Poltergeist',
            "Doctor": 'Horror',
            "Patient": 'Ghost (Haunted Stage)',
        },
        incidents: [
    ...
    {
        titel: 'ジブン観察日記 (My Observation Diary)',
        creator: 'Translated by megakun',
        set: {
            name: 'Haunted Stage',
            number: 2,
        ...
        tragedySet: 'Haunted Stage',
        mainPlot: ['Prim Evil'],
        subPlots: ['Zombie Apocalypse', 'The Deep Hole'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 4,
        }],
        ...
        cast: {
            ...
            "Girl Student": 'Horror',
            "Rich Man’s Daughter": 'Person',
            "Shrine Maiden": 'Monster',
            "Police Officer": 'Person',
            "Office Worker": 'Person',
            "Informer": 'Person',
            "Doctor": 'Nightmare (Haunted Stage)',
            "Patient": 'Ghost (Haunted Stage)',
        },
        incidents: [
            ...
            {
                day: 4,
                incident: 'Monster Liberation',
                culprit: 'Boy Student',
            },
            {
                day: 5,
                incident: 'Hundred Demons Night',
                culprit: 'Office Worker',
            },
        ],
        specifics: '',
    ...
    },
    {
        ...
        tragedySet: 'Haunted Stage',
        mainPlot: ['Full Moon Night'],
        subPlots: ['Boundary Between Life and Death', 'The Deep Hole'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 4,
        }],
        ...
        cast: {
            "Boy Student": 'Horror',
            "Girl Student": 'Person',
            "Rich Man’s Daughter": 'Spellcaster',
            "Shrine Maiden": 'Werwolf (Haunted Stage)',
            "Police Officer": 'Monster',
            "Office Worker": 'Nightmare (Haunted Stage)',
            "Informer": 'Overlorad',
            "Doctor": 'Monster',
            "Patient": 'Person',
        },
    ...
    },
    {
        ...
        daysPerLoop: 5,
        cast: {
            "Boy Student": 'Nightmare (Haunted Stage)',
            "Girl Student": 'Werwolf (Haunted Stage)',
            "Rich Man’s Daughter": 'Spellcaster',
            "Shrine Maiden": 'Spellcaster',
            "Police Officer": 'Person',
            "Office Worker": 'Person',
            "Informer": 'Horror',
            "Doctor": 'Person',
    ...
    {
        titel: '猿マネ椅子盗りゲーム (Aimless Imitation Chair Stealing Game)',
        creator: 'Translated by megakun',
        set: {
            name: 'Haunted Stage',
            number: 5,
        ...
        tragedySet: 'Haunted Stage',
        mainPlot: ['Prim Evil'],
        subPlots: ['Boundary Between Life and Death', 'Dance Party of the Dead'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 5,
        }],
        ...
        cast: {
            "Boy Student": 'Horror',
            "Girl Student": 'Nightmare (Haunted Stage)',
            "Rich Man’s Daughter": 'Person',
            "Shrine Maiden": 'Monster',
            "Police Officer": 'Ghost (Haunted Stage)',
            "Office Worker": 'Person',
            "Informer": 'Person',
            "Doctor": 'Ghost (Haunted Stage)',
            "Patient": 'Overlorad',
        },
        incidents: [
    ...
    },
    {
        ...
        tragedySet: 'Haunted Stage',
        mainPlot: ['Ancient Shrine'],
        subPlots: ['Max Crazy Gauge', 'Expanding Urban Legend'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 7,
        }],
        ...
        cast: {
            ...
            "Rich Man’s Daughter": 'Person',
            "Shrine Maiden": 'Person',
            "Police Officer": 'Nightmare (Haunted Stage)',
            "Patient": 'Person',
            "Pop Idol": 'Horror',
            "Journalist": 'Person',
            "Henchman": 'Ghost (Haunted Stage)',
            "Scientist": 'Curse God',
        },
        incidents: [
    ...
    {
        titel: '蘇る幻影（マボロシ） (Reviving Phantom (Maboroshi))',
        creator: 'Translated by megakun',
        set: {
            name: 'Haunted Stage',
            number: 7,
        ...
        tragedySet: 'Haunted Stage',
        mainPlot: ['Prim Evil'],
        subPlots: ['The Deep Hole', 'Dance Party of the Dead'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 1,
        }],
        ...
        cast: {
            ...
            "Class Rep": 'Person',
            "Alien": 'Person',
            "Pop Idol": 'Ghost (Haunted Stage)',
            "Journalist": 'Horror',
            "Boss": ['Nightmare (Haunted Stage)', { Turf: 'School' }],
            "Illusion": 'Ghost (Haunted Stage)',
        },
        incidents: [
        ...
        specialRules: 'Mastermind remove "Forbid Goodwill" from his hand. It cannot be used on any loop',
        specifics: '',
        story: '',
        mastermindHints: '',
    },
    {
        titel: '幻想は都市で死ぬ (Illusions Die in the City)',
        creator: 'Translated by megakun',
        set: {
            name: 'Haunted Stage',
            number: 8,
        ...
        tragedySet: 'Haunted Stage',
        mainPlot: ['Full Moon Night'],
        subPlots: ['The Deep Hole', 'Max Crazy Gauge'],
        difficultySets: [{
            difficulty: 1,
            numberOfLoops: 4,
        }],
        daysPerLoop: 6,
        cast: {
            "Boy Student": 'Werwolf (Haunted Stage)',
            "Shrine Maiden": 'Person',
            "Office Worker": 'Ghost (Haunted Stage)',
            "Informer": 'Horror',
            "Mystery Boy": 'Curse God',
            "Pop Idol": 'Nightmare (Haunted Stage)',
            "Journalist": 'Spellcaster',
            "Scientist": 'Monster',
            "Illusion": 'Person',
        },
        incidents: [
